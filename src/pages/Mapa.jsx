  ...
  return (
    <main className="mapa">
      ...
      <section className="trilha-membros">
        ...
        <Tracejado id="trilha_conhecimentos" comeco="circulo" final="seta" d="M4 76 V7" />
        ...
        <div className="rotas-container">
            <Tracejado id="trilha_materiais-1" final="" d="M147.849 120 V0" />
            ...
            <Tracejado id="tresd_godot" comeco="circulo" final="seta" d="M5.04456 60 V0" />
            <Tracejado id="cpp_opengl" comeco="circulo" final="seta" d="M5.04456 70 V0" />
            <Tracejado id="lua_doisd" comeco="circulo" final="seta" d="M5.04456 70 V0" />
        </div>
